    ...
    <form action="https://formspree.io/f/xdkwrvkj" class="fs-form fs-layout__2-column" target="_top" method="POST">
        ...
        <div class="fs-checkbox-field col-span-full">
            <div class="fs-checkbox-wrapper">
                <input class="fs-checkbox" id="dpa-consent" name="dpa-consent" required type="checkbox"
                    value="consent" />
            </div>
            <div>
...
const businessOptions = [
    { value: 'PanoramaStitching', label: 'PanoramaStitching' },
    { value: 'EasyInstall', label: 'EasyInstall' }
];
