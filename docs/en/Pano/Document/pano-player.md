...
![Pano Player](/Pano/PanoPlayer.jpg)

| Playback mode | Feature Description |
| ---- | ---- |
| **Low latency playback** | Real time acquisition of camera stream splicing and playback, with low latency. |
| **Stream playback**      | Obtain panoramic video playback from splicing software, with slightly higher latency. |

![Pano Player](/Pano/PanoPlayer2.jpg)